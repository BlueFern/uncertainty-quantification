...
Using the results of Figure~\ref{fig:all_parameters} we deduce that only 13 of the original 70 parameters should be varied. Having found this subset of parameters we are now ready to build and surrogate model on the lower dimensional parameter space and use it to solve a Bayesian inverse problem to discover the parameters correlations.
...
\end{center}
\caption{Total Sobol' indices for 70 parameters in the 8 channels. The black vertical lines are separating the channels. There are a total of 13 parameters whose total Sobol' index is greater than or equal to 0.01.}
